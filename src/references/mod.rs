    ...
    T: IoDeSer,
{
    fn to_io_string(&self, tab: u8, buffer: &mut String) {
        self.as_ref().to_io_string(tab, buffer); //todo?
    }
...
{
    fn to_io_string(&self, tab: u8, buffer: &mut String) {
        self.as_ref().to_io_string(tab, buffer);
    }
...
{
    fn to_io_string(&self, tab: u8, buffer: &mut String) {
        self.lock().unwrap().to_io_string(tab, buffer);
    }
...
{
    fn to_io_string(&self, tab: u8, buffer: &mut String) {
        self.borrow().to_io_string(tab, buffer);
    }
...
{
    fn to_io_string(&self, tab: u8, buffer: &mut String) {
        self.get().to_io_string(tab, buffer);
    }
...
{
    fn to_io_string(&self, tab: u8, buffer: &mut String) {
        self.upgrade().unwrap().to_io_string(tab, buffer);
    }
...
{
    fn to_io_string(&self, tab: u8, buffer: &mut String) {
        self.read().unwrap().to_io_string(tab, buffer);
    }
